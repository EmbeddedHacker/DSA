/*
    @goal: You will be given a non-empty array of integers.
           ...
           and all non-negtive numbers are stacked on the right
           side of the array.

           Your job is to right shift and rotate all non-negative elements.

    @boundary case: There may not be any negtive element, in that case
...
int main(void)
{
    ...
    int b[9] = {30, 10, 2, 25, 30, 16, 28, 40};

    printf("Showing array \'a\' BEFORE right shift and rotate: \n");
    display(a, 8);
    right_shift_and_rotate(a, 8);
    printf("Showing array \'a\' AFTER right shhift and rotate: \n");
    display(a, 8);
